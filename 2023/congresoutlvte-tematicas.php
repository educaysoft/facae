...
<div style="width: 60%; display: flex;flex-direction:column;justify-content: center;align-items: center;">
  ...
  <div style=" margin: auto;text-align: center;">
    <p style="font-size:20px; margin:10px 10px 10px 0px;"> Calidad de la Gestión Innovadora y descriptiva de los negocios. </p>
...
<div style=" display: flex; flex-direction:row; justify-content: center; width:100%;" >
  ...
  <div style=" width: 60%; display: flex;flex-direction:column; justify-content: center;align-items: center;">
    <div style=" margin: auto;text-align: center;">
      <p style="font-size: 20px; margin:10px 0 10px 0;">Tecnología y su relación con el crecimiento y el desarrollo económico. </p>
...
<div style=" display: flex; flex-direction:row; justify-content: center; width:100%;" >
  ...
  <div style=" width: 60%; display: flex;flex-direction:column; justify-content: center;align-items: center;">
    <div style=" margin: auto;text-align: center;">
      <p style="font-size: 20px; margin:10px 0 10px 0;"> Liderazgo, comunicación interna y Cultura Organizacional. </p>
